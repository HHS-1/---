...
<head>
    ...
    <script src="../admin_js/admin_qaview.js?v=1"></script>
</head>
<body>
...
<article class="admin_lists">
    ...
    <ul class="qa_write">
        ...
        <li>답변</li>
        <li><textarea placeholder="답변내용을 입력하세요" class="answer" id="qadmin" name="qadmin" readonly><%=rs.getString("qadmin") %></textarea></li>
    </ul>
